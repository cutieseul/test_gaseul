...
<p>어디로 배송할까요?</p>
<form action="payment.do" id="form" method="post">
<div id="payment"></div>
<div id="callBackDiv"></div>   
                                       <!-- value="" -->
<div>수령자명 : <input type="text" name="uName" style="width:50px;"></div>
<div>전화번호 : <input type="text" name="uPhone" style="width:100px;" placeholder="전화번호를 입력해주세요."></div>
<div>이메일 : <input type="email" name="uEmail" style="width:100px;" placeholder="이메일을 입력해주세요."></div>
<div>주소 : <input type="text"  style="width:50px;" id="zipNo"  name="uAddress" />
<button type="button" onClick="goPopup();"> 주소찾기</button></div>
 <div style="padding-left: 2.9em"><div><input type="text"  style="width:300px;" id="address"  name="uAddress" placeholder="주소를 입력해주세요."/></div>
</div>   
<p>배송지 유형이 어떻게 되나요?</p>
...
<form action="paymentmethod.do?" method="post">
